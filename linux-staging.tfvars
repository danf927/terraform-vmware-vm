# LINUX-STAGING.TFVARS
# =================================================
# Deployment spec: Linux Staging ("Linux-Staging" customization spec, "Linux-GOLD"
...
#
# USAGE:  terraform apply -var-file="linux-staging.tfvars"
# =================================================
# Author:  Dan Fereday
...
# target_virtual_port_group: Staging network for this spec
target_virtual_port_group = "Network-Staging"

# --- Template / Customization (spec-level, do not change per deployment) ---

vm_template      = "Linux-GOLD"
vm_customization = "Linux-Staging"

# --- Linux customization spec settings ---
# Sourced from: Get-OSCustomizationSpec -Name "Linux-Staging" | Select-Object *
