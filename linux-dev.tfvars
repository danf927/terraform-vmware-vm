# LINUX-DEV.TFVARS
# =================================================
# Deployment spec: Linux Development ("Linux-Dev" customization spec, "Linux-GOLD"
...
#
# USAGE:  terraform apply -var-file="linux-dev.tfvars"
# =================================================
# Author:  Dan Fereday
...
# target_virtual_port_group: Development network for this spec
...
vm_customization = "Linux-Dev"

# --- Linux customization spec settings ---
# Sourced from: Get-OSCustomizationSpec -Name "Linux-Dev" | Select-Object *
